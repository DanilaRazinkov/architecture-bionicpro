...
def parse_datetime(date_str):
    """
    Преобразует строку в datetime.datetime или возвращает None.
    Поддерживает форматы:
      - '2025-04-05 14:30:00'
      - '2025-04-05 14:30:00.123'
    """
...
def df_to_xcom(df, ti, key):
    """Сериализует DataFrame в CSV и отправляет через XCom"""
    csv_buffer = StringIO()
...
def xcom_to_df(ti, task_id, key):
    """Получает CSV из XCom и конвертирует в DataFrame"""
